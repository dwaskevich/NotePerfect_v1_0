...
namespace CharLCDmp_v1_3
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CharLCDmp_v1_3.CyCustomCharacter current = (CharLCDmp_v1_3.CyCustomCharacter)sender;
            CharLCDmp_v1_3.CyBox clickedBox = current.GetBoxByLocation(e.X, e.Y);
            if (clickedBox != null)
            {
        ...
        private void custArray_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                CharLCDmp_v1_3.CyCustomCharacter current = (CharLCDmp_v1_3.CyCustomCharacter)sender;
                CharLCDmp_v1_3.CyBox currentBox = current.GetBoxByLocation(e.X, e.Y);
                if (currentBox != null)
                {
        ...
        {
            CharLCDmp_v1_3.CyCustomCharacter selectedCharacter = (CharLCDmp_v1_3.CyCustomCharacter)sender;
        ...
        public void CYStringToCharacter(CyCustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            CharLCDmp_v1_3.CyBox[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CyCustomCharacter customCharacter)
        {
            ...
            CharLCDmp_v1_3.CyBox[,] pixelArray = customCharacter.GetBoxArray();
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CharLCDmp_v1_3.CyCustomCharacter)m_userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCDmp_v1_3.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCDmp_v1_3.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCDmp_v1_3.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
        ...
        private void CustomCharactersOff()
        {
            ...
            for (int i = 0; i < this.panel1.Controls.Count; i++)
            {
                CharLCDmp_v1_3.CyCustomCharacter character = (CharLCDmp_v1_3.CyCustomCharacter)this.panel1.Controls[i];
