...
void `$INSTANCE_NAME`_Init(void) `=ReentrantKeil($INSTANCE_NAME . "_Init")`
{
    ...
    `$INSTANCE_NAME`_WrCntrlNib(0x26);   /* Selects 8-bit mode */
    CyDelay(5u); 
     `$INSTANCE_NAME`_WrCntrlNib(0x0C);   /* Selects 8-bit mode */
    CyDelay(5u);
     `$INSTANCE_NAME`_WrCntrlNib(0x06);   /* Selects 8-bit mode */
    CyDelay(5u);
     `$INSTANCE_NAME`_WrCntrlNib(0x02);   /* Selects 8-bit mode */
    CyDelay(5u);
     `$INSTANCE_NAME`_WrCntrlNib(0x01);   /* Selects 8-bit mode */
    CyDelay(5u);
